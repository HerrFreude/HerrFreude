...
//background color
static const char col_gray1[]       = "#1c272c"; /*302924*/
//inactive window border
static const char col_gray2[]       = "#292929";
//font color
static const char col_gray3[]       = "#6be5b0"; /*#8bd0de*/
//current tag and current window font color
static const char col_gray4[]       = "#d2d9d8"; /*#f7eee6*/
//top bar second color and active window border color
static const char col_cyan[]        = "#434a4c"; /*#fcc54e*/
